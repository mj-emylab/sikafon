            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <wo-table
                            :total-records="getAreaBosses ? getAreaBosses.length : 0"
                            :remote="false"
                            :columns="columns"
...
<script>
    ...
    import AreaBossModal from '../../Modals/AreaBossModal.vue';

    import { createNamespacedHelpers } from 'vuex';
    const { mapActions, mapGetters } = createNamespacedHelpers('administration');

    export default {
            components: { WoTable, AreaBossModal },
        ...
        methods: {
        ...mapActions(['allAreaBossAction', 'deleteAreaBossAction', 'updateAreaBossAction']),

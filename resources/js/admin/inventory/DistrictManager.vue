  ...
  <div>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">District Manager</li>
      </ol>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    <ul style="background-color: #B22222;" class="nav nav-tabs">
                    ...
                    <div class="tab-content">
                        ...
                        <wo-table
                            :total-records="getDistrictManagers ? getDistrictManagers.length : 0"
                            :remote="false"
                            :columns="columns"
                            :enable-check-box="false"
                            :rows="getDistrictManagers">
    ...
    <district-manager-modal ref="districtManager" />
...
<script>
    ...
    import DistrictManagerModal from '../../Modals/DistrictManagerModal.vue';

    import { createNamespacedHelpers } from 'vuex';
    const { mapActions, mapGetters } = createNamespacedHelpers('administration');

    export default {
            components: { WoTable, DistrictManagerModal },
            ...
            data() {
                ...
                columns: [
                    ...
                    { label: 'District', field: 'district.name'},
        ...
        methods: {
        ...mapActions(['allDistrictManagerAction', 'deleteDistrictManagerAction', 'updateDistrictManagerAction']),
            ...
            deleteItem(row) {
                ...
                .then((result) => {
                    if (result.value) {
                        this.isLoading = true;
                        this.deleteDistrictManagerAction(row)
                        .then((res) => {
        ...
        computed: {
            ...mapGetters(['getDistrictManagers']),
        },

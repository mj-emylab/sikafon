<template>
    <div>
         <modal ref="woModal" modal-class-name="AddDistrict" :modalClasses="'modal-md'">
...
export default {
    ...
    methods: {
        ...mapActions(['updateDistrictAction', 'saveDistrictAction', 'allDistrictAction', 'allRegionAction']),

        openAddModal() {
            this.clearData();
            this.addOrUpdate = false;
            // helper.openModal(".AddDistrict");
        ...
        saveData() {
            ...
            if(this.addOrUpdate) {
                ...
                this.updateDistrictAction(data).then((res) => {
                ...
                const data = this.formData;
                this.saveDistrictAction(data).then((res) => {
                    this.saveLoading = false;

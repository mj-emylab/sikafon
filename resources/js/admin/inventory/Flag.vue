            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <wo-table
                            :total-records="getFlags ? getFlags.length : 0"
                            :remote="false"
                            :columns="columns"
                            :enable-check-box="false"
                            :rows="getFlags">
                            <template #is_percent="{row}">
                                <span style="text-color: white; background-color:#FF0000;" class="badge badge-success" v-if="row.is_percent == 1">
                                    Percentage
                                </span>
                                <span style="text-color: white; background-color:#2E8B57;" class="badge badge-danger" v-if="row.is_percent == 0">
                                    Value
                                </span>
                            </template>
                            <template #status="{row}">
...
<script>
    ...
    export default {
        ...
        methods: {
        ...mapActions(['allFlagAction', 'deleteFlagAction', 'updateFlagAction']),

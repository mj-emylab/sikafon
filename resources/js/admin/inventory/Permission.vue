<template>
  ...
  <div>
            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <wo-table
                            :total-records="getPermissions ? getPermissions.length : 0"
                            :remote="false"
                            :columns="columns"
    ...
    <permission-modal ref="permission" />
...
<script>
    ...
    export default {
            components: { WoTable, PermissionModal },
        ...
        methods: {
        ...mapActions(['allPermissionAction', 'deletePermissionAction', 'updatePermissionAction']),
            ...
            deleteItem(row) {
                ...
                .then((result) => {
                    if (result.value) {
                        this.isLoading = true;
                        this.deletePermissionAction(row)
                        .then((res) => {

<template>
  ...
  <div>
            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <wo-table
                            :total-records="getAreaManagers ? getAreaManagers.length : 0"
                            :remote="false"
                            :columns="columns"
                            :enable-check-box="false"
                            :rows="getAreaManagers">
    ...
    <area-manager-modal ref="areaManager" />
...
<script>
    ...
    import AreaManagerModal from '../../Modals/AreaManagerModal.vue';

    import { createNamespacedHelpers } from 'vuex';
    const { mapActions, mapGetters } = createNamespacedHelpers('administration');

    export default {
            components: { WoTable, AreaManagerModal },
        ...
        methods: {
        ...mapActions(['allAreaManagerAction', 'deleteAreaManagerAction', 'updateAreaManagerAction']),
            ...
            deleteItem(row) {
                ...
                .then((result) => {
                    if (result.value) {
                        this.isLoading = true;
                        this.deleteAreaManagerAction(row)
                        .then((res) => {

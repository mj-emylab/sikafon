            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <wo-table
                            :total-records="getProfessional ? getProfessional.length : 0"
                            :remote="false"
                            :columns="columns"
                            :enable-check-box="false"
                            :rows="getProfessional">
                            <template #name="{row}">
...
<script>
    ...
    export default {
        ...
        created() {
            this.professionalAction(this.formData).then((res) => {
                this.pageData = this.getProfessional

<template>
    <div>
         <modal ref="woModal" modal-class-name="AddCountry" :modalClasses="'modal-md'">
...
export default {
    ...
    methods: {
        ...mapActions(['updateCountryAction', 'saveCountryAction', 'allCountryAction']),

        openAddModal() {
            this.clearData();
            this.addOrUpdate = false;
            // helper.openModal(".AddCountry");
        ...
        saveData() {
            ...
            if(this.addOrUpdate) {
                ...
                this.updateCountryAction(data).then((res) => {
                ...
                const data = this.formData;
                this.saveCountryAction(data).then((res) => {
                    this.saveLoading = false;

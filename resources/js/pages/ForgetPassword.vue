    ...
    <div class="row min-vh-100">
      <div class="col-md-8 col-lg-6 col-xl-5 d-flex align-items-center">
        <div class="w-100 py-5 px-md-5 px-xxl-6 position-relative">
          ...
          <form @submit.prevent="submitEmail" class="form-validate">
            <div class="mb-4">
              <label class="form-label" for="findMeId">Please Enter Your Findme ID</label>
              <input class="form-control" v-model="user.findmeId" name="findMeId" id="findMeId" type="text" placeholder="findme ID" autocomplete="off" required data-msg="Please enter your findme ID without (e-)">
            </div>
            <!-- Submit-->
            <div class="d-grid">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapActions(['createTokenPasswordReset']),
      ...
      submitEmail() {
        ...
        this.createTokenPasswordReset(user)
        .then((res) => {
            console.log(res)
            this.isLoading = false;
            Helper.successAlert("Email sent ...");

            this.$router.push({ path: "/validate_code" });

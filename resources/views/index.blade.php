...
<body>
    <div style="padding-top: 18vh;">
        <div class="d-flex mx-auto justify-content-center">
            <input style="text-align: center; margin-right: 10px;" id="amount" placeholder="amount" type="text" class="text-primary" />
        </div>

        <div class="d-flex mx-auto justify-content-center">
            <input style="text-align: center; margin-right: 10px; " id="qr_code_image" type="file" class="text-primary" />
            <button class="btn btn-success" onclick="verifyCode()">Verify Code</button> <!-- Add a button to trigger the function -->
        </div>
        <br>
        <div class="d-flex mx-auto justify-content-center">
    ...
    <script>
        ...
        function verifyCode() {
            ...
            const qrCodeImage = document.getElementById('qr_code_image').files[0]; // Get the file from input

            const formData = new FormData();
            formData.append('amount', amount);
            formData.append('qr_code_image', qrCodeImage); // Append the file to the form data
            formData.append('trans_type', 2);

            axios.post(apiUrl + '/verify_code', formData, {
                headers: {

            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <wo-table
                            :total-records="getPromotions ? getPromotions.length : 0"
                            :remote="false"
                            :columns="columns"
                            :enable-check-box="false"
                            :rows="getPromotions">
                            <template #link="{row}">
                                {{ row.link+'&code='+row.code }}
                            </template>
                            <template #status="{row}">
                            ...
                            <template #actions="{row}">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a  @click.prevent="showModal(row)" class="dropdown-item"  title="Edit" href="#">
                                            <i class="fa fa-pencil text-success"></i> Show
                                        </a>
...
<script>
    ...
    export default {
            components: { WoTable, PromotionModal },
        ...
        methods: {
        ...mapActions(['allPromotionAction', 'deletePromotionAction', 'updatePromotionAction']),
            ...
            deleteItem(row) {
                ...
                .then((result) => {
                    if (result.value) {
                        this.isLoading = true;
                        this.deletePromotionAction(row)
                        .then((res) => {
            ...
            editModal() {
                // this.$refs.promotion.openEditModal();
            },
        },
        created() {
